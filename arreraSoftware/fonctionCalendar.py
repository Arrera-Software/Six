...
class fncArreraAgenda:
    ...
    def __windows(self):
        ...
        # Widget Frame Agenda
        labelYesterday = Label(frameYesterday, text=yesterday.strftime("%A %d/%m/%Y"), font=("Arial", "13"),
                               bg=self.__mainColor)
        labelToday = Label(frameToday, text=today.strftime("%A %d/%m/%Y"), font=("Arial", "13"), bg="green")
        labelTomorrow = Label(frameTomorrow, text=tomorrow.strftime("%A %d/%m/%Y"), font=("Arial", "13"),
                              bg=self.__mainColor)
        ...
        # FrameAdd
        labelAdd = Label(self.__frameAdd, text="Ajout d'un événement", font=("arial", "20"), bg=self.__mainColor,
                         fg=self.__textColor)
        labelDate = Label(self.__frameAdd, text="Choisir date : ", font=("arial", "15"), bg=self.__mainColor,
                          fg=self.__textColor)
        labelName = Label(self.__frameAdd, text="Nom du rappel : ", font=("arial", "15"), bg=self.__mainColor,
                          fg=self.__textColor)
        ...
        btnValiderAdd = Button(self.__frameAdd, text="Ajouter", font=("arial", "15"), bg=self.__mainColor,
                               fg=self.__textColor,
                               command=lambda: self.__addEvent(self.__formatageDateEntry(chooseDate), entryName))
        btnAnnulerAdd = Button(self.__frameAdd, text="Annuler", font=("arial", "15"), bg=self.__mainColor,
                               fg=self.__textColor,
        ...
        frameDay3.place(x=(frameYesterday.winfo_reqwidth() + frameToday.winfo_reqwidth()),
                        y=(frameYesterday.winfo_reqheight()))
    ...
    def __setLabelResumer(self):
        ...
        nbTomorrow, listEvent = self.__checkEvent(
            str(tomorrow.year) + "-" + str(tomorrow.month) + "-" + str(tomorrow.day))
        ...
        if (nbTomorrow == 0):
            ...
            if (nbTomorrow == 1):
                ...
                self.__labelTitreResumer.configure(text=str(nbTomorrow) + " événements prévu pour cette date",
                                                   wraplength=130)
        ...
        if (nbDay1 == 0):
            ...
            if (nbDay1 == 1):
                ...
                self.__labelResumerDay1.configure(text=str(nbDay1) + " événements prévu pour cette date",
                                                  wraplength=130)
        ...
        if (nbDay3 == 0):
            ...
            if (nbDay3 == 1):
                ...
                self.__labelResumerDay3.configure(text=str(nbDay3) + " événements prévu pour cette date",
                                                  wraplength=130)
